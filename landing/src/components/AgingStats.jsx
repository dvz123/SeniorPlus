          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1rem"}}>
              {visionFeatures.map((feature, index) => (
                <div key={index} style={{ display: "flex", gap: "1rem", alignItems:"center", marginRight:"2rem" }}>
          ...
          <div style={{ position: "relative" }}>
            ...
            >
              ...
              >
                ...
                <span style={{ fontSize: "0.875rem", fontWeight: "500", color: "var(--color-text)" }}>FATEC Cotia</span>
              </div>
            </div>
          </div>
        </div>
